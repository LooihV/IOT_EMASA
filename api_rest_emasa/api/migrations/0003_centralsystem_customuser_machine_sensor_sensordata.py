    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('type', models.CharField(choices=[('voltaje', 'Voltaje'), ('corriente', 'Corriente'), ('presion', 'Presion'), ('temperatura', 'Temperatura')], max_length=11)),
                ('machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sensors', to='api.machine')),
            ],
        ),
        migrations.CreateModel(
            name='SensorData',

...
The classes and functions of the api are declared at api-rest-emasa/api/models.py file, the api-rest-emasa/api/serializer.py file is the file which can perform the classes actions and the api-rest-emasa/api/views.py is the users view from the drf panel administration the routes are declared at the api-rest-emasa/api/urls.py file and the actions related to chirpstack are detail at the second (2) subtitle of this file.
